...
const AcademyCard = ({ img, title, paragraph }) => {
  return (
    <div className="card-border flex flex-col border-[1px] border-none px-4 bg-gradient-to-b from-[#1A1A1AB2] to-[#1A1A1A66] rounded-[32px] blur-[0.5px] pt-8 pb-10 bg-cover bg-center">
