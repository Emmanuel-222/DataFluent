  ...
  return (
    <div className="container text-[#FAFAFA] h-screen w-screen bg-black">
      <section className="flex items-center flex-col contact-background w-screen">
        ...
        <p className="text-[#BDBDBD] text-center mx-4 md:mx-0 mb-12 md:mb-0">Explore our diverse portfolio of impactful digital solutions</p>
        <h1 className="mt-[30rem] md:mt-96 font-[600] text-[20px] md:text-[40px] text-center mb-4">Explore Our Projects</h1>
      </section>
      <section className="flex items-center flex-col w-screen academy-background">
        <div className="bg-[#1A1A1AB2] rounded-3xl border-solid border-[1px] border-transparent mx-4">
          <ProjectCard />
          <Pagination />
        </div>
      </section>
